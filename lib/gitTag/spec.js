...
describe('gitTag', async() => {
    ...
    it('Should create a git tag with given message and push it', async() => {
        ...
        await gitTag({version: '1.1.1', subject: 'Hello, world'});
    ...
    it('Should use a given user', async() => {
        ...
        await gitTag({version: '1.1.1', subject: 'Hello, world', author: 'Username', email: 'email@website.org'});
        expect(lines).to.have.lengthOf(0);
    });
    ...
    it('Should Add a tag prefix', async() => {
        ...
        await gitTag({version: '1.1.1', subject: 'Hello, world', publishConfig: 'v'});
        expect(lines).to.have.lengthOf(0);
    });
});
